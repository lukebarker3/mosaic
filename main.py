...
class MosaicApp(CommandLineApp):
    ...
    def _add_mosaic_params(self):
        ...
        self.add_param('o', '--out', required=False, default=utils.MosaicArgs.out_file, action='store', help='Send mosaic image to a custom file name.', type=str)
    ...
    def main(self):
        ...
        try:
            self.generator = MosaicGenerator()
            self.generator.run()
